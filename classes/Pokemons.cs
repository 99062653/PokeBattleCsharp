namespace PokemonsSpace
{
	...
	class Init
	{
		public static void InitializePokemons()
		{
			...
			Pokemon Bulbasaur = new Pokemon("Bulbasaur", "Grass", 45, 49, new Dictionary<string, int>() { { "Seed Bomb", 55 }, { "Sludge Bomb", 80 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			...
			Pokemon Chikorita = new Pokemon("Chikorita", "Grass", 45, 49, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Bayleef = new Pokemon("Bayleef", "Grass", 60, 62, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Meganium = new Pokemon("Meganium", "Grass", 80, 82, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Cyndaquil = new Pokemon("Cyndaquil", "Fire", 39, 52, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Quilava = new Pokemon("Quilava", "Fire", 58, 64, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Typhlosion = new Pokemon("Typhlosion", "Fire", 78, 84, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Totodile = new Pokemon("Totodile", "Water", 50, 65, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Croconaw = new Pokemon("Croconaw", "Water", 65, 80, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Feraligatr = new Pokemon("Feraligatr", "Water", 85, 105, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Sentret = new Pokemon("Sentret", "Normal", 35, 46, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Furret = new Pokemon("Furret", "Normal", 85, 76, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Hoothoot = new Pokemon("Hoothoot", "Normal", 60, 30, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Noctowl = new Pokemon("Noctowl", "Normal", 100, 50, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Ledyba = new Pokemon("Ledyba", "Bug", 40, 20, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Ledian = new Pokemon("Ledian", "Bug", 55, 35, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Spinarak = new Pokemon("Spinarak", "Bug", 40, 60, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Ariados = new Pokemon("Ariados", "Bug", 70, 90, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Crobat = new Pokemon("Crobat", "Poison", 85, 90, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Chinchou = new Pokemon("Chinchou", "Water", 75, 38, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Lanturn = new Pokemon("Lanturn", "Water", 125, 58, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Pichu = new Pokemon("Pichu", "Electric", 20, 40, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Cleffa = new Pokemon("Cleffa", "Normal", 50, 25, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Igglybuff = new Pokemon("Igglybuff", "Normal", 90, 30, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Togepi = new Pokemon("Togepi", "Normal", 35, 20, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Togetic = new Pokemon("Togetic", "Normal", 55, 40, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Natu = new Pokemon("Natu", "Psychic", 40, 50, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Xatu = new Pokemon("Xatu", "Psychic", 65, 75, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Mareep = new Pokemon("Mareep", "Electric", 55, 40, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Flaaffy = new Pokemon("Flaaffy", "Electric", 70, 55, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Ampharos = new Pokemon("Ampharos", "Electric", 90, 75, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Bellossom = new Pokemon("Bellossom", "Grass", 75, 80, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Marill = new Pokemon("Marill", "Water", 40, 20, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Azumarill = new Pokemon("Azumarill", "Water", 100, 50, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Sudowoodo = new Pokemon("Sudowoodo", "Rock", 70, 30, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Politoed = new Pokemon("Politoed", "Water", 90, 60, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Hoppip = new Pokemon("Hoppip", "Grass", 35, 35, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Skiploom = new Pokemon("Skiploom", "Grass", 55, 45, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Jumpluff = new Pokemon("Jumpluff", "Grass", 75, 55, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Aipom = new Pokemon("Aipom", "Normal", 55, 55, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Sunkern = new Pokemon("Sunkern", "Grass", 30, 30, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Sunflora = new Pokemon("Sunflora", "Grass", 75, 75, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Yanma = new Pokemon("Yanma", "Bug", 65, 65, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Wooper = new Pokemon("Wooper", "Water", 55, 45, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Quagsire = new Pokemon("Quagsire", "Water", 95, 85, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Espeon = new Pokemon("Espeon", "Psychic", 65, 65, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Umbreon = new Pokemon("Umbreon", "Dark", 95, 65, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Murkrow = new Pokemon("Murkrow", "Dark", 60, 30, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Slowking = new Pokemon("Slowking", "Water", 95, 75, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Misdreavus = new Pokemon("Misdreavus", "Ghost", 60, 60, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Unown = new Pokemon("Unown", "Psychic", 48, 48, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Wobbuffet = new Pokemon("Wobbuffet", "Psychic", 190, 190, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Girafarig = new Pokemon("Girafarig", "Normal", 70, 80, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Pineco = new Pokemon("Pineco", "Bug", 50, 50, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Forretress = new Pokemon("Forretress", "Bug", 75, 75, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Dunsparce = new Pokemon("Dunsparce", "Normal", 100, 100, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Gligar = new Pokemon("Gligar", "Ground", 65, 65, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Steelix = new Pokemon("Steelix", "Steel", 75, 75, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Snubbull = new Pokemon("Snubbull", "Fairy", 60, 60, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Granbull = new Pokemon("Granbull", "Fairy", 90, 90, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Qwilfish = new Pokemon("Qwilfish", "Water", 65, 65, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Scizor = new Pokemon("Scizor", "Bug", 75, 75, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Shuckle = new Pokemon("Shuckle", "Bug", 20, 20, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Heracross = new Pokemon("Heracross", "Bug", 80, 80, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Sneasel = new Pokemon("Sneasel", "Dark", 55, 55, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Teddiursa = new Pokemon("Teddiursa", "Normal", 60, 60, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Ursaring = new Pokemon("Ursaring", "Normal", 90, 90, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Slugma = new Pokemon("Slugma", "Fire", 40, 40, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Magcargo = new Pokemon("Magcargo", "Fire", 50, 50, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Swinub = new Pokemon("Swinub", "Ice", 50, 50, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Piloswine = new Pokemon("Piloswine", "Ice", 100, 100, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Corsola = new Pokemon("Corsola", "Water", 65, 65, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Remoraid = new Pokemon("Remoraid", "Water", 35, 35, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Octillery = new Pokemon("Octillery", "Water", 75, 75, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Delibird = new Pokemon("Delibird", "Ice", 45, 45, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Mantine = new Pokemon("Mantine", "Water", 65, 65, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Skarmory = new Pokemon("Skarmory", "Steel", 65, 65, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Houndour = new Pokemon("Houndour", "Dark", 45, 45, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Houndoom = new Pokemon("Houndoom", "Dark", 75, 75, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Kingdra = new Pokemon("Kingdra", "Water", 75, 75, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Phanpy = new Pokemon("Phanpy", "Ground", 90, 90, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Donphan = new Pokemon("Donphan", "Ground", 90, 90, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Porygon2 = new Pokemon("Porygon2", "Normal", 85, 85, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Stantler = new Pokemon("Stantler", "Normal", 73, 73, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Smeargle = new Pokemon("Smeargle", "Normal", 55, 55, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Tyrogue = new Pokemon("Tyrogue", "Fighting", 35, 35, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Hitmontop = new Pokemon("Hitmontop", "Fighting", 50, 50, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Smoochum = new Pokemon("Smoochum", "Ice", 45, 45, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Elekid = new Pokemon("Elekid", "Electric", 45, 45, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Magby = new Pokemon("Magby", "Fire", 45, 45, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Miltank = new Pokemon("Miltank", "Normal", 95, 95, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Blissey = new Pokemon("Blissey", "Normal", 255, 255, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Raikou = new Pokemon("Raikou", "Electric", 90, 90, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Entei = new Pokemon("Entei", "Fire", 90, 90, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Suicune = new Pokemon("Suicune", "Water", 90, 90, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Larvitar = new Pokemon("Larvitar", "Rock", 50, 50, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Pupitar = new Pokemon("Pupitar", "Rock", 70, 70, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Tyranitar = new Pokemon("Tyranitar", "Rock", 100, 100, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Lugia = new Pokemon("Lugia", "Psychic", 106, 106, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon HoOh = new Pokemon("Ho-Oh", "Fire", 106, 106, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
			Pokemon Celebi = new Pokemon("Celebi", "Psychic", 100, 100, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } });
