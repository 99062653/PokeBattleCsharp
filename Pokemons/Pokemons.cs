	...
	class Init
	{
		public static void InitializePokemons()
		{
			...
			if (Program.loadFirstGenPokemons) 
			{
				...
				Pokemon Bulbasaur = new Pokemon("Bulbasaur", "Grass", 45, 49, new Dictionary<string, int>() { { "Tackle", 1 } }, new Dictionary<string, int>() { { "Fire", 2 } }, new Dictionary<string, int>() { { "Water", 1 } }, 1);
